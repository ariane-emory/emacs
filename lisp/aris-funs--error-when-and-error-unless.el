...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(--make-error-if-macro error-unless  not
  "Assert that the last expression in FORMAT-ARGS-AND-BODY is not nil. If it is
not, signal an error with ERROR-MESSAGE and FORMAT-ARGS-AND-BODY.
...
Acceptable cases:
  ...
  (error-when \"Raise an %s, %s,  %s\"
    '(\"error because the condition\" it \"is true.\")
    2 (progn nil) (not nil))
  ...
  (error-when
    (concat
       \"Raise an \" \"error because \" \"the condition,
       \" (format \"%s\" it) \", is true.\")
    (progn 3) 4 \"true\")
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(--make-error-if-macro error-when identity
