...
(defun blink-cursor-timer-function ()
  "Zarza wrote the original version of this cyberpunk variant of timer `blink-cursor-timer'.

Kat has modified it so that it will choose colours randomly when blink-cursor-random is true and so that it updates the colour of beacon-mode's beacon to match the cursor's color at the time the beacon starts.
...
Warning: overwrites original version in `frame.el'."
  (when (not (internal-show-cursor-p))
    ...
    (setq beacon-color last-blink-cursor-color)
