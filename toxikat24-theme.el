...
(custom-theme-set-faces
  ...
  '(error ((t (:foreground "#e00" :weight bold))))
  ...
  '(rainbow-delimiters-base-error-face ((t (:inherit rainbow-delimiters-base-face :foreground "#FF000")))) ;
  ...
  '(term-underline ((t (:inherit ansi-color-underline :foreground "#74cfa8"))))
  ...
  '(font-lock-warning-face ((t (:weight bold :foreground "#ff0055"))))
